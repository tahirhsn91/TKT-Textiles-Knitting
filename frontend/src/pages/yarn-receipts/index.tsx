                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <p className="font-medium text-foreground">Doc #{r.docNumber}</p>
                    ...
                    <div className="mt-3 grid grid-cols-2 gap-y-2 text-sm">
                      <div>
                        ...
                        <p className="mt-0.5 num font-medium">{r.lineCount}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-xs uppercase tracking-wide text-muted-foreground">Bags</p>
                        <p className="mt-0.5 num font-medium">{r.totalQty}</p>
                      </div>
