              ...
              <CardContent className="p-0">
                ...
                <div className="hidden sm:block">
                  <div className="px-4 pt-4 pb-2 border-b bg-card">
                    <div className="grid grid-cols-[2fr_2fr_2fr_2fr_2fr_2fr_1.25fr_1.75fr_1.5fr_auto] gap-2 font-medium text-sm text-muted-foreground">
                        <div>Yarn Type</div>
                        <div>Yarn Count</div>
                        <div>Yarn Brand</div>
                        <div>UOM</div>
                    ...
                    <div className="space-y-2" ref={lineItemsRef}>
                      {fields.map((field, index) => (
                        <div key={field.id} className="grid grid-cols-[2fr_2fr_2fr_2fr_2fr_2fr_1.25fr_1.75fr_1.5fr_auto] gap-2 items-start">
                          <FormField
                            control={form.control}
                            name={`details.${index}.yarnTypeId`}
                            render={({ field }) => (
