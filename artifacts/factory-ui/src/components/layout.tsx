...
import { Factory, FileText, Database } from "lucide-react";
  ...
  return (
    <div className="min-h-[100dvh] flex w-full flex-col bg-background">
      <header className="sticky top-0 z-10 flex h-14 items-center gap-6 border-b bg-card px-6 shadow-sm">
        <Link href="/" className="flex items-center gap-2 font-semibold text-primary transition-colors hover:text-primary/80 shrink-0">
